### NeuralABRLW Training
###
### Objective: Train the NN parameters of a NeuralABRLW parameterization
...
LW_SCHEME   = get(v, :lw_scheme, SpeedyExt.SpeedyAnalyticBandLongwave(SG))
...
# NN Architecture
WIDTH       = get(v, :width, 64)
N_HIDDEN    = get(v, :n_hidden, 2)

# Statistics
ZCSORE      = get(v, :zscore, "zscore_abrlw_default")  
SCALING     = get(v, :scaling, "scaling_abrlw_default")
...
scheme = NeuralABRLW(SG, arch; zscore_folder=ZCSORE, def_co2=CO2, def_ocean_em=OCEAN_EM, def_land_em=LAND_EM)
